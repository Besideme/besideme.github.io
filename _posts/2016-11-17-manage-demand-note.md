...
> 需求管理的两个维度：需求来源管理和需求实现管理  

1. 分段交付产品，MVP实现核心需求  

MVP产品可以从以下几个维度确定功能范围：  

- 用户维度：MVP集中满足核心用户/种子用户的需求  
- 功能维度：找出最核心、与痛点最相关、最小的功能组合。减少需求永远比增加需求更难，这里可以用反向分析法，如果去掉某个功能，会不会影响主体流程。某个需求如果上不了线，用户会不会流失，如果回答是会，则放入mvp中实现，如果不会大胆的放到后续的迭代中做  
- 产品原型：现在更多的产品会通过微信公众号的形式验证，比如知乎的付费问答值乎，最开始的mvp产品形态主要是知乎服务号的自定义菜单或者朋友圈的分享  
...
- 将用户需求转化为功能需求  
- 与马斯洛需求进行匹配，确定功能需求的需求等级，底层需求优先级最高 1 3 5 7 9   
...
> 做哪些工作，才能成功地搭建一套好的产品模型  

- 痛点：目标用户付出某种行动的最大阻碍     
- 如何发现市场痛点：把自己当做用户，一步步体验整个流程，记录亮点和困惑  
